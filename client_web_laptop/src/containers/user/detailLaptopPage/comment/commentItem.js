...
import {
    Col, Row, PopoverBody, Popover, Input, Button,
    FormGroup, Form, Modal, ModalBody, ModalFooter
} from 'reactstrap';
                                ...
                                <Col sm="11" style={{ paddingTop: "0.5rem", borderRadius: "16px", backgroundColor: "#F2F3F5" }}>
                                    <span>
                                        <p>
                                            ...
                                            {comment.content}
                                            <i className="fas fa-ellipsis-h" id={`popover${comment.id}`} style={{ float: "right", cursor: "pointer" }}></i>
                                        </p>
                                    </span>
                                </Col>
                            </Row>
